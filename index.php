...
<body onLoad="init()" oncontextmenu=self.event.returnValue=false>
    <div id="GameScoreLayer" class="BBOX SHADE bgc1" style="display:none;">
        <div style="padding:5%;margin-top: 200px;background-color: rgba(125, 181, 216, 0.3);">
                ...
                <button type="button" class="btn btn-secondary btn-lg" onclick="openWebpage('https://github.com/OneSitos/EatKun/blob/main/README_EN.md#others')" data-i18n="license">LICENSE-I18N</button>
                ...
                <button type="button" class="btn btn-secondary btn-lg" onclick="openWebpage('https://github.com/OneSitos/EatKun/blob/main/README_EN.md#disclaimer')" data-i18n="disclaimer">DISCLAIMER-I18N</button>
            </div>
    </div>
    </div>
